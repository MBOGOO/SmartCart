    ...
    if (empty($_POST['d_name']) || empty($_POST['about']) || $_POST['price'] == '' || $_POST['res_name'] == '' || $_POST['stock'] == '') {
        ...
        if ($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {
            ...
            if (move_uploaded_file($temp, $store)) {
                ...
                // ✅ Insert item data into the database (with stock)
                $sql = "INSERT INTO items (rs_id, title, slogan, price, stock, img)
                ...
                $success = '<div class="alert alert-success alert-dismissible fade show">
                                ...
                                <strong>Congrats!</strong> New item added successfully.
                            </div>';
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="d_name" class="form-control" placeholder="SMOCHA">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group has-danger">
                                                <label>About</label>
                                                <input type="text" name="about" class="form-control" placeholder="About Item">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row p-t-20">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="stock" min="0" class="form-control" placeholder="Enter available stock">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group has-danger">
