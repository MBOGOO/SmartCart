...
if (isset($_POST['submit'])) {           // if upload btn is pressed
    ...
    if (empty($_POST['res_name']) || $_POST['email'] == '' || $_POST['phone'] == '' || $_POST['url'] == '' || $_POST['o_hr'] == '' || $_POST['c_hr'] == '' || $_POST['o_days'] == '' || $_POST['address'] == '') {
        ...
        if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'png' || $extension == 'gif') {
            ...
            // ✅ Removed file size restriction
            $res_name = $_POST['res_name'];

            // Insert into database
            $sql = "INSERT INTO store (title, email, phone, url, o_hr, c_hr, o_days, address, image)
            VALUES ('".$res_name."', '".$_POST['email']."', '".$_POST['phone']."', '".$_POST['url']."', 
                    '".$_POST['o_hr']."', '".$_POST['c_hr']."', '".$_POST['o_days']."', '".$_POST['address']."', '".$fnew."')";
