...
header("refresh:2;url=index.php"); // Redirects back to login after 2 seconds
exit();
...
<div class="form">
  ...
  <form class="login-form" action="index.php" method="post">
    ...
    <input type="submit"  name="submit" value="login" />
     <p class="message">New admin? <a href="#">Create an account</a></p>
  </form>
