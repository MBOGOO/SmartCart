...
error_reporting(0);               // hide undefined index notices (you can change for dev)
session_start();                 // start session for login

// Centralized logged-in flag — reuse this across templates
    ...
    <header id="header" class="header-scroll top-header headrom">
        ...
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php">JEPE CAPITAL</a>
                <div class="collapse navbar-toggleable-md float-lg-right" id="mainNavbarCollapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="shop.php">Section <span class="sr-only"></span></a>
                        </li>

                        <?php
                        /*
                          Navigation behavior:
                          - Guests (not logged in) may browse products. They see login & signup links.
                          - Logged-in users see "Your Orders" and "Logout".
                          Use the $isLogged flag elsewhere to hide "Add to cart" if not logged in.
                        */
                        if (! $isLogged) { // user not logged in
...
?>
    ...
    <!-- banner part starts -->
    <section class="hero bg-image" data-image-src="images/groceries.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Get products at your comfort</h1>
                <h5 class="font-white space-xs">TO BE THE CHOICE TO MANY FOR PROVISION OF CREDIT SERVICES IN THE RURAL COMMUNITY OF KENYA.</h5>
                ...
                <!-- 7. Step Process Section (How It Works) -->
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4><span>1. </span>Choose Section</h4>
                    </div>
                    ...
                    <div class="step-item step2">
                        ...
                        <h4><span>2. </span>Order Products</h4>
                    </div>
