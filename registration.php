               ...
               <div class="container">
                  ...
                  <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                     <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item"> <a class="nav-link active" href="shop.php">Section <span class="sr-only"></span></a> </li>
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle collapsed" href="#faq1" aria-expanded="false"><i class="ti-info-alt" aria-hidden="true"></i>Can choose your favourite Products</a></h4>
                           </div>
                        ...
                        <p> <a href="mailto:kangethealex5972@gmail.com" class="btn theme-btn m-t-15">Mail us</a> </p>
                     </div>
                     <!-- /WHY? -->
                  </div>
               </div>
