...
<body>
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php" style="color:black"> JEPE CAPITAL</a>
        ...
        <div class="page-wrapper">
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active"><span>1</span><a href="shop.php">Choose Section</a></li>
            ...
            <div class="inner-page-hero bg-image" data-image-src="images/groceries.jpg">
